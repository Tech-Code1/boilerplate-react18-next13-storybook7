...
function ContentLogin() {
  return (
    <div className='flex flex-row relative'>
        <div className={`w-[353px] h-[643px] flex flex-col rounded-l-lg ${style['content-style-login']}`}>
            <Image src={userLogin} alt="user-login" className='flex absolute -bottom-32 -left-64'></Image>
        </div>
